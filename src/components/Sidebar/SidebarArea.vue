...
//                   xmlns="http://www.w3.org/2000/svg"
//                 >
//                    <path fill="" d="${mdiIcons.mdiHomeOutline}" />
//                 </svg>`,
//         label: 'Dashboard',
//         route: '/'
//       },
...
//                   xmlns="http://www.w3.org/2000/svg"
//                 >
//                   <path fill="" d="${mdiIcons.mdiDatabaseOutline}"
//                   />
//                 </svg>`,
//         label: 'Master',
//         route: '#',
//         children: [
//           { label: 'Company', route: '/' },
//           { label: 'User Role', route: '/' },
//           { label: 'User Internal', route: '/' },
//           { label: 'User External', route: '/' },
...
//         route: '#',
//         children: [
//           { label: 'Evident', route: '#', children: [
//             { label: 'PSB', route: '/modules/work-order/evident/psb'},
//             { label: 'MT', route: '/modules/work-order/evident/psb'},
//             { label: 'INFRA', route: '/modules/work-order/evident/psb'},
//           ]},
