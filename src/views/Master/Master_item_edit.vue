...
import { item_UpdateDataWithImages, item_getItemById } from "@/stores/functionAPI";
...
const handleAddMaterialTerpakai = async () => {
  ...
  savedData.value.item_konversi.push({
    satuan_awal: "",
    qty_awal: "",
    satuan_akhir: "",
    qty_akhir: "",
...
const handleRemoveMaterialTerpakai = async (index) => {
  await confirmDelete(null, null, async () => {
    savedData.value.item_konversi.splice(index, 1);
  });
};
...
const submitData = async () => {
  ...
  //   // Editkan validasi qtyKeluar tidak boleh kurang dari 1
  ...
  if (result.isConfirmed) {
    try {
      ...
      await item_UpdateDataWithImages(sendData, route.params.id);
  ...
  <DefaultLayout>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div class="flex flex-col gap-9">
        <!-- Input Fields Start -->
        <DefaultCard cardTitle="Ubah Data">
          <div class="flex flex-col gap-2 p-6.5">
            ...
            <div>
              ...
              <div>
                ...
                <textarea
                  rows="3"
                  placeholder="Ubah keterangan disini!"
                  class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-3 px-5 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
      ...
      <div class="flex flex-col gap-9">
        <!-- Input Fields Start -->
        <DefaultCard cardTitle="Ubah Konversi">
          <div class="p-6.5">
            <div class="flex flex-col gap-2 xl:flex-row">
              ...
              <div class="w-1/12 flex items-end pb-2 flex-wrap">
                <button
                  class="flex w-full justify-center cursor-pointer font-medium text-blue-600 hover:bg-opacity-90"
            ...
            <div
              ...
              v-if="savedData && savedData.item_konversi.length > 0"
              :class="index === 0 ? '' : 'pt-2'"
            >
              <div class="w-3/12">
                <input
