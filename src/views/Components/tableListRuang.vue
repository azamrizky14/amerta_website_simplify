...
import { lokasi_getDataByType } from "@/stores/functionAPI";
import {
  mdiEyeOutline,
  mdiMagnify,
  mdiRefresh,
...
const pageTitle = ref("Work Order - Gudang");
  ...
  <div>
    ...
    >
      ...
      <div class="right-data flex items-center flex-row-reverse">
        <!-- Add Button -->
        <router-link to="/master/location/add" class="px-1 hidden">
          <svg
